...
class ProductLabelPolicy
{
    ...
    {
        return $user->can('view_any_product::label');
    }
    ...
    {
        return $user->can('view_product::label');
    }
    ...
    {
        return $user->can('create_product::label');
    }
    ...
    {
        return $user->can('update_product::label');
    }
    ...
    {
        return $user->can('delete_product::label');
    }
    ...
    {
        return $user->can('delete_any_product::label');
    }
    ...
    {
        return $user->can('force_delete_product::label');
    }
    ...
    {
        return $user->can('force_delete_any_product::label');
    }
    ...
    {
        return $user->can('restore_product::label');
    }
    ...
    {
        return $user->can('restore_any_product::label');
    }
    ...
    {
        return $user->can('replicate_product::label');
    }
    ...
    {
        return $user->can('reorder_product::label');
    }
}
