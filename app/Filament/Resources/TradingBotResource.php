...
use App\Filament\Resources\TradingBotResource\Pages;
use App\Filament\Resources\TradingBotResource\RelationManagers;
...
class TradingBotResource extends Resource
{
    protected static ?string $model = TradingBot::class;
    protected static ?string $modelLabel = 'ربات معامله گر';
    protected static ?string $pluralModelLabel = 'ربات های معامله گر';
                                ...
                                Section::make('نمای ربات')
                                    ->schema([
                                        ...
                                        FileUpload::make('thumbnail')
                                            ...
                                            ->directory('trading-bot/thumbnail')
                                            ->uploadingMessage('در حال آپلود...')
                                            ->required()
                                            ->image()
                                                    ...
                                                    $exists = SKU::where('sku', $value)
                                                        ->where(function ($query) use ($recordId) {
                                                            $query->where('model_id', '!=', $recordId)
                                                                ->where('model_type', TradingBot::class);
                                                        })
                                                        ->exists();
                                                    if ($exists) {
    ...
    {
        return [
            'index' => Pages\ListTradingBots::route('/'),
            'create' => Pages\CreateTradingBot::route('/create'),
            'edit' => Pages\EditTradingBot::route('/{record}/edit'),
        ];
    }
